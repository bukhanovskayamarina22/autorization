...
import 'package:autorization/widgets/popup_no_user.dart';
...
void main() {
  ...
  testWidgets('popup no user has been renderer', (tester) async {
  ...
  group("Widget content check", () {
    testWidgets("Check title", (WidgetTester tester) async {
      ...
      await tester.tap(button);
      await tester.pump();
      expect(find.byKey(ValueKey("Title text")), findsOneWidget);
    ...
    testWidgets("Check content", (WidgetTester tester) async {
      ...
      await tester.tap(button);
      await tester.pump();
      expect(find.byKey(ValueKey("Text body popup no user")), findsOneWidget);
